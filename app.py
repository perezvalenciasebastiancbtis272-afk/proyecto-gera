...
client = MongoClient("mongodb+srv://perezvalenciasebastiancbtis272_db_user:Celuse781015@escuelacbtis.n6vid5q.mongodb.net/")
db = client.ESCUELA
...
def ver_alumno(id):
    ...
    if alumno:
        return render_template('detail.html', alumno=alumno)
    else:
